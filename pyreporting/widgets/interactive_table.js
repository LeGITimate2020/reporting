...
export class InteractiveTableWidgetView extends InputWidgetView {
  ...
  initialize(options) {
    ...
    const initializeReact = () => {
      ...
      pyreporting.initializeBokehInteractiveTable({model: this.model});
    };
    setTimeout(initializeReact, 0);
  }
}

export class InteractiveTableWidget extends InputWidget {
  static initClass() {

    // If there is an associated view, this is boilerplate.
    this.prototype.default_view = InteractiveTableWidgetView;

    // The ``type`` class attribute should generally match exactly the name
    // of the corresponding Python class.
    this.prototype.type = "InteractiveTableWidget";
...
InteractiveTableWidget.initClass();
