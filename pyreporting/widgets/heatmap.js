...
export class HeatmapWidgetView extends InputWidgetView {
...
export class HeatmapWidget extends InputWidget {
  static initClass() {

    // If there is an associated view, this is boilerplate.
    this.prototype.default_view = HeatmapWidgetView;

    // The ``type`` class attribute should generally match exactly the name
    // of the corresponding Python class.
    this.prototype.type = "HeatmapWidget";
